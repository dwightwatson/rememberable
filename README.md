...
Based on the architecture of the package it is possible to delete the cache for a both a single query and any tagged queries using cache tags, you are able to flush the cache for the tag:
